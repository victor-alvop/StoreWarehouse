...
def etl_agg_daily_sales_product(**kwargs):
    try:
        ...
        print(f"Error during ETL agg_daily_sales_product: {e}")
        raise
...
with DAG(
    dag_id="dag_agg_daily_sales_product",
    ...
    etl_task = PythonOperator(
        task_id="etl_agg_daily_sales_product",
        python_callable=etl_agg_daily_sales_product,
